...
const team = [
    { name: "AI Ekibi", role: "Yapay Zeka Geliştirme", bio: "Gelişmiş makine öğrenmesi modelleri ile kişiselleştirilmiş öğrenme algoritmaları geliştiriyoruz.", color: "rgba(117,105,143,0.12)", icon: <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 2a7 7 0 0 1 7 7c0 2.38-1.19 4.47-3 5.74V17a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2v-2.26C6.19 13.47 5 11.38 5 9a7 7 0 0 1 7-7z" /></svg> },
    { name: "Eğitim Ekibi", role: "Pedagoji & İçerik", bio: "VARK modeli uzmanlarımız ile bilimsel temelli öğrenme içerikleri ve stratejiler tasarlıyoruz.", color: "rgba(93,143,139,0.12)", icon: <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" /><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" /></svg> },
    { name: "Tasarım Ekibi", role: "UX/UI Tasarım", bio: "Modern ve erişilebilir arayüzler ile kullanıcı deneyimini en üst düzeye çıkarıyoruz.", color: "rgba(180,125,84,0.12)", icon: <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="10" /><path d="M12 16v-4" /><path d="M12 8h.01" /></svg> },
];

const values = [
    { title: "Erişilebilirlik", desc: "Herkes için eşit ve kaliteli eğitim fırsatları sunuyoruz.", color: "rgba(117,105,143,0.1)", border: "rgba(117,105,143,0.2)", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="10" /><path d="M12 16v-4" /><path d="M12 8h.01" /></svg> },
    { title: "İnovasyon", desc: "En son AI teknolojilerini eğitim alanına uyguluyoruz.", color: "rgba(93,143,139,0.1)", border: "rgba(93,143,139,0.2)", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" /></svg> },
    { title: "Bilimsellik", desc: "Tüm stratejilerimiz bilimsel araştırmalara dayanmaktadır.", color: "rgba(95,141,107,0.1)", border: "rgba(95,141,107,0.2)", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M22 12h-4l-3 9L9 3l-3 9H2" /></svg> },
];
