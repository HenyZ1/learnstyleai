...
export const styleResults = {
    visual: { title: "Görsel Öğrenme Stiliniz Baskın! 👁️", icon: "👁️", iconBg: "rgba(117,105,143,0.15)", description: "Siz görsel bir öğrenicisiniz! Grafikler, diyagramlar, renkler ve görsel düzenlemeler sizin en güçlü öğrenme araçlarınız.", tips: ["Zihin haritaları ve diyagramlar oluşturarak çalışın", "Renkli kalemler ve highlight kullanarak not alın", "Video eğitimlerden ve infografiklerden faydalanın", "Öğrendiğiniz konuları görsel şemalara dönüştürün", "Flash kartlar oluşturup görsel tekrar yapın"] },
    auditory: { title: "İşitsel Öğrenme Stiliniz Baskın! 🎧", icon: "🎧", iconBg: "rgba(93,143,139,0.15)", description: "Siz işitsel bir öğrenicisiniz! Dinleyerek, tartışarak ve sesli tekrar yaparak en iyi şekilde öğrenirsiniz.", tips: ["Podcast ve sesli kitapları öğrenme aracı olarak kullanın", "Konuları sesli okuyarak tekrar edin", "Çalışma gruplarına katılıp tartışın", "Kayıt yaparak notlarınızı sesli formata çevirin", "Arkaplanda hafif müzik eşliğinde çalışın"] },
    readwrite: { title: "Okuma/Yazma Stiliniz Baskın! 📝", icon: "📝", iconBg: "rgba(101,120,149,0.15)", description: "Siz okuma/yazma odaklı bir öğrenicisiniz! Metin tabanlı materyaller, yazılı notlar ve listeler sizin en etkili öğrenme araçlarınız.", tips: ["Detaylı ve düzenli notlar tutun", "Öğrendiğiniz konuları kendi kelimelerinizle yazın", "Listeler, taslaklar ve özetler oluşturun", "Ders kitapları ve makaleler sizin en güçlü kaynağınız", "Blog yazma veya günlük tutma alışkanlığı edinin"] },
    kinesthetic: { title: "Kinestetik Öğrenme Stiliniz Baskın! 🤸", icon: "🤸", iconBg: "rgba(180,125,84,0.15)", description: "Siz kinestetik bir öğrenicisiniz! Yaparak, dokunarak ve deneyimleyerek en iyi şekilde öğrenirsiniz.", tips: ["Bilgileri uygulamalı projelerle pekiştirin", "Çalışırken kısa molalar verin ve hareket edin", "Laboratuvar deneylerinden ve simülasyonlardan faydalanın", "Rol yapma ve senaryo çalışmaları deneyin", "Stres topu gibi objeler kullanarak konsantrasyonunuzu artırın"] },
};
