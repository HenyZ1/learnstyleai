                    ...
                    <svg width="280" height="280" viewBox="0 0 200 200" fill="none" className={styles.logoSvg}>
                        <defs>
                            <linearGradient id="heroGrad" x1="0" y1="0" x2="200" y2="200">
                                <stop offset="0%" stopColor="#497672" /><stop offset="100%" stopColor="#596b86" />
                            </linearGradient>
                        ...
                        <circle cx="100" cy="100" r="90" fill="#f4f7f6" /><circle cx="100" cy="100" r="90" fill="url(#heroGrad)" opacity="0.08" />
                        <path d="M50 70 L50 140 L95 130 L95 60 Z" fill="#aebbd0" opacity="0.62" />
                        <path d="M150 70 L150 140 L105 130 L105 60 Z" fill="#b3c9c4" opacity="0.68" />
                        <path d="M95 60 L100 55 L105 60 L105 130 L100 135 L95 130 Z" fill="url(#heroGrad)" className={styles.spine} />
                        <g stroke="#497672" strokeWidth="2.5" strokeLinecap="round" filter="url(#heroGlow)">
                            ...
                            {[[60, 80], [60, 95], [60, 110], [85, 80], [85, 95], [85, 110]].map(([cx, cy], i) => <circle key={`ln${i}`} cx={cx} cy={cy} r="3" fill="#86aaa5" className={styles.circuitNode} style={{ animationDelay: `${i * 0.2}s` }} />)}
                        </g>
                        <g stroke="#497672" strokeWidth="2.5" strokeLinecap="round" filter="url(#heroGlow)">
                            ...
                            {[[115, 80], [115, 95], [115, 110], [140, 80], [140, 95], [140, 110]].map(([cx, cy], i) => <circle key={`rn${i}`} cx={cx} cy={cy} r="3" fill="#86aaa5" className={styles.circuitNode} style={{ animationDelay: `${i * 0.2 + 0.1}s` }} />)}
                        </g>
                        <g><rect x="93" y="88" width="14" height="14" rx="2" fill="#497672" className={styles.aiChip} /><circle cx="100" cy="95" r="3.5" fill="#f4f7f6" /><line x1="93" y1="95" x2="85" y2="95" stroke="#86aaa5" strokeWidth="1.5" /><line x1="107" y1="95" x2="115" y2="95" stroke="#86aaa5" strokeWidth="1.5" /></g>
                        <path d="M50 70 L50 140 L95 130 L95 60 Z" fill="none" stroke="#497672" strokeWidth="0.8" opacity="0.5" />
                        <path d="M150 70 L150 140 L105 130 L105 60 Z" fill="none" stroke="#497672" strokeWidth="0.8" opacity="0.5" />
                        <circle cx="100" cy="100" r="70" fill="none" stroke="#497672" strokeWidth="0.5" opacity="0.15" className={styles.pulseRing} />
                        <circle cx="100" cy="100" r="85" fill="none" stroke="#497672" strokeWidth="0.5" opacity="0.1" className={styles.pulseRing} style={{ animationDelay: "1.5s" }} />
                    </svg>
